...
const GetSearchItemController = async (req, res) => {
    try {
        const { q } = req.query;
        ...
        const items = await inventory_1.default.find({
        ...
        // Perform aggregation
        const inventory_data = await inventory_1.default.aggregate([{ $match: match }]);
...
exports.default = GetSearchItemController;
